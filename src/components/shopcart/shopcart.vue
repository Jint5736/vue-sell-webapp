    ...
    <div class="shopcart">
        ...
        <div class="ball-container">
            <transition-group name="drop" tag="div" v-on:before-enter="beforeEnter" v-on:enter="enter" v-on:after-enter="afterEnter">
                <div class="ball" v-for="ball in balls" v-bind:key="ball.id" v-show="ball.show">
    ...
    export default {
        ...
        methods: {
            ...
            pay() {
                ...
                let totalAllPrice = this.totalPrice + this.deliveryPrice;
                alert(`共需支付${totalAllPrice}元,您的余额不足`);
            },
            toggleList() {
                if (!this.totalCount) {
                    return;
