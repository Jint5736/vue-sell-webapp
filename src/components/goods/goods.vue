<template>
    <div class="goods">
        ...
        <div class="foods-wrapper" ref="foodsWrapper">
            <ul>
                <li v-for="item in goods" :key="item.id" class="food-list foodsWrapper">
    ...
    export default {
        ...
        methods: {
            selectMenu(index, event) {
                ...
                let foodList = this.$refs.foodsWrapper.getElementsByClassName('foodsWrapper');
                let el = foodList[index];
                this.foodsScroll.scrollToElement(el, 120);
            },
